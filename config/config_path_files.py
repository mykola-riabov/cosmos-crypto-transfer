...
class PathFileName:
    ...
    enabled_networks = os.path.join(path.data_path, filename.filename_enabled_networks)
    generated_ibc_routes = os.path.join(path.data_path, filename.filename_generated_ibc_routes)
    assets_registry = os.path.join(path.data_path, filename.filename_assets_registry)
    list_chain_id = os.path.join(path.data_path, filename.filename_dict_chain_id)
