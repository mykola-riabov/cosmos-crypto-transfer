...
def check_custom_balances_addresses_book(filepath_json1, filepath_json2, filepath_json3, filepath_py, wallet_names,
                                         update_interval):
    ...
    try:
        ...
        while True:
                ...
                if "address" in addr:
                    ...
                    try:
                        ...
                        for balance_item in balance:
                            ...
                            requests.exceptions.HTTPError, requests.exceptions.RequestException, ConnectionError,
                            RuntimeError) as e:
                        if isinstance(e, requests.exceptions.HTTPError) and e.response.status_code == 504:
                            ...
                            data.append([wallet_name, network, "timeout", denom_name])
                        else:
            ...
            stdscr.addstr(0, 0, tabulate(data, headers=headers, tablefmt='grid', numalign='right', floatfmt=".6f"))
            stdscr.refresh()
